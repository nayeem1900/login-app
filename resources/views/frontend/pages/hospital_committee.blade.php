...
@section('content')
    <p style="text-align: center; font-size: 30px;" ><strong>Hospital Committee</strong></p>
    <div class="container">
        <div class="row">
            <div class="col-md-3">
        ...
        <!--<div class="card" style="width: 18rem;">
            ...
            <div class="col-md-9">
                ...
                <div class="card mb-3">
                    ...
                    <div class="col-md-4">
                        <img src="{{url('frontend/images/Yousif Abdullah 1A AlRajhi.jpg')}}" alt="...">
                    </div>
                    <div class="col-md-12">
                        <div class="card-body">
                            <h5 class="card-title">Member</h5>
                            <p class="card-text" style="text-align: justify">Yousif Abdullah A AlRajhi is a Vice Chairman of the Board of Directors of the Bank. He completed his graduation in Business Administration majoring in Economics & Political Science from King Saud University, KSA in 1986. Then he obtained MA degree in Development Administration from Western Michigan University, USA in 1991. He also completed Internal Auditor Course, Chain Management & Leadership Course and Speed Reading and Development Round Attendance Certificate Course. Mr. Yousif is General Manager-cum CEO of Al-Rajhi Company for Industry and Trade, KSA with 29 years of work exposure including banking career with Al-Rajhi Banking and Investment Corporation. He is also a board member of many shareholder Corps in Saudi Arabia and outside. He visited various eastern and western countries of the world and participated in many international seminars, symposia and conferences.</p>
                        </div>
                    </div>

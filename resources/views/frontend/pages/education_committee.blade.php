...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <strong>  Executive Committee of Islami Bank Health Educational Institutions
                    (Medical College, Nurding College, Health Technology & Nursing Institute)
                </strong>
                ...
                <div class="card mb-3" style="max-width: 720px;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Chairmanr</h5>

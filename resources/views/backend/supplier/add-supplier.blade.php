                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" >
                                ...
                                <form method="POST" action="{{(@$editData)?route('suppliers.update',$editData->id):route('suppliers.store')}}" id="myForm" enctype="multipart/form-data" >
                                    @csrf

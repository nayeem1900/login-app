                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            <td>{{($value->name)}}</td>
                                            @php
                                                $count_unit =App\Models\Product::where('unit_id',$value->id)->count();
                                            @endphp


                                            <td>

                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('units.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{route('units.delete',$value->id)}}" method="post">
                                                                    @csrf

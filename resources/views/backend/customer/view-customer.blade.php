                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('customers.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{route('customers.delete',$value->id)}}" method="post">
                                                                    @csrf
